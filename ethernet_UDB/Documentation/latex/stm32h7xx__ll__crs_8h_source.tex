\hypertarget{stm32h7xx__ll__crs_8h_source}{}\doxysection{stm32h7xx\+\_\+ll\+\_\+crs.\+h}
\label{stm32h7xx__ll__crs_8h_source}\index{C:/Users/User\_4/STM32CubeIDE/workspace\_1.10.1/ethernet\_UDB/Drivers/STM32H7xx\_HAL\_Driver/Inc/stm32h7xx\_ll\_crs.h@{C:/Users/User\_4/STM32CubeIDE/workspace\_1.10.1/ethernet\_UDB/Drivers/STM32H7xx\_HAL\_Driver/Inc/stm32h7xx\_ll\_crs.h}}
...
\DoxyCodeLine{20 \textcolor{preprocessor}{\#ifndef STM32H7xx\_LL\_CRS\_H}}
\DoxyCodeLine{21 \textcolor{preprocessor}{\#define STM32H7xx\_LL\_CRS\_H}}
\DoxyCodeLine{22 }
...
\DoxyCodeLine{81 \textcolor{preprocessor}{\#define LL\_CRS\_SYNC\_DIV\_1                  0x00000000U                               }}
...
\DoxyCodeLine{96 \textcolor{preprocessor}{\#define LL\_CRS\_SYNC\_SOURCE\_GPIO            0x00000000U             }}
...
\DoxyCodeLine{106 \textcolor{preprocessor}{\#define LL\_CRS\_SYNC\_POLARITY\_RISING        0x00000000U           }}
\DoxyCodeLine{107 \textcolor{preprocessor}{\#define LL\_CRS\_SYNC\_POLARITY\_FALLING       CRS\_CFGR\_SYNCPOL      }}
\DoxyCodeLine{115 \textcolor{preprocessor}{\#define LL\_CRS\_FREQ\_ERROR\_DIR\_UP           0x00000000U         }}
\DoxyCodeLine{116 \textcolor{preprocessor}{\#define LL\_CRS\_FREQ\_ERROR\_DIR\_DOWN         CRS\_ISR\_FEDIR       }}
\DoxyCodeLine{129 \textcolor{preprocessor}{\#define LL\_CRS\_RELOADVALUE\_DEFAULT         0x0000BB7FU}}
\DoxyCodeLine{130 }
\DoxyCodeLine{134 \textcolor{preprocessor}{\#define LL\_CRS\_ERRORLIMIT\_DEFAULT          0x00000022U}}
\DoxyCodeLine{135 }
\DoxyCodeLine{142 \textcolor{preprocessor}{\#define LL\_CRS\_HSI48CALIBRATION\_DEFAULT    0x00000020U}}
\DoxyCodeLine{151 \textcolor{comment}{/* Exported macro -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{167 \textcolor{preprocessor}{\#define LL\_CRS\_WriteReg(\_\_INSTANCE\_\_, \_\_REG\_\_, \_\_VALUE\_\_) WRITE\_REG(\_\_INSTANCE\_\_-\/>\_\_REG\_\_, (\_\_VALUE\_\_))}}
\DoxyCodeLine{168 }
\DoxyCodeLine{175 \textcolor{preprocessor}{\#define LL\_CRS\_ReadReg(\_\_INSTANCE\_\_, \_\_REG\_\_) READ\_REG(\_\_INSTANCE\_\_-\/>\_\_REG\_\_)}}
\DoxyCodeLine{195 \textcolor{preprocessor}{\#define \_\_LL\_CRS\_CALC\_CALCULATE\_RELOADVALUE(\_\_FTARGET\_\_, \_\_FSYNC\_\_) (((\_\_FTARGET\_\_) / (\_\_FSYNC\_\_)) -\/ 1U)}}
\DoxyCodeLine{196 }
\DoxyCodeLine{205 \textcolor{comment}{/* Exported functions -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{220 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_EnableFreqErrorCounter(\textcolor{keywordtype}{void})}
\DoxyCodeLine{221 \{}
\DoxyCodeLine{222   SET\_BIT(CRS-\/>CR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gace21476d647129c935f84daf84d91699}{CRS\_CR\_CEN}});}
\DoxyCodeLine{223 \}}
\DoxyCodeLine{224 }
\DoxyCodeLine{230 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_DisableFreqErrorCounter(\textcolor{keywordtype}{void})}
\DoxyCodeLine{231 \{}
\DoxyCodeLine{232   CLEAR\_BIT(CRS-\/>CR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gace21476d647129c935f84daf84d91699}{CRS\_CR\_CEN}});}
\DoxyCodeLine{233 \}}
\DoxyCodeLine{234 }
\DoxyCodeLine{240 \_\_STATIC\_INLINE uint32\_t LL\_CRS\_IsEnabledFreqErrorCounter(\textcolor{keywordtype}{void})}
\DoxyCodeLine{241 \{}
\DoxyCodeLine{242   \textcolor{keywordflow}{return} ((READ\_BIT(CRS-\/>CR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gace21476d647129c935f84daf84d91699}{CRS\_CR\_CEN}}) == (\mbox{\hyperlink{group___peripheral___registers___bits___definition_gace21476d647129c935f84daf84d91699}{CRS\_CR\_CEN}})) ? 1UL : 0UL);}
\DoxyCodeLine{243 \}}
\DoxyCodeLine{244 }
\DoxyCodeLine{250 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_EnableAutoTrimming(\textcolor{keywordtype}{void})}
\DoxyCodeLine{251 \{}
\DoxyCodeLine{252   SET\_BIT(CRS-\/>CR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gafa48432b942f1896e05a2eff91178edd}{CRS\_CR\_AUTOTRIMEN}});}
\DoxyCodeLine{253 \}}
\DoxyCodeLine{254 }
\DoxyCodeLine{260 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_DisableAutoTrimming(\textcolor{keywordtype}{void})}
\DoxyCodeLine{261 \{}
\DoxyCodeLine{262   CLEAR\_BIT(CRS-\/>CR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gafa48432b942f1896e05a2eff91178edd}{CRS\_CR\_AUTOTRIMEN}});}
\DoxyCodeLine{263 \}}
\DoxyCodeLine{264 }
\DoxyCodeLine{270 \_\_STATIC\_INLINE uint32\_t LL\_CRS\_IsEnabledAutoTrimming(\textcolor{keywordtype}{void})}
\DoxyCodeLine{271 \{}
\DoxyCodeLine{272   \textcolor{keywordflow}{return} ((READ\_BIT(CRS-\/>CR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gafa48432b942f1896e05a2eff91178edd}{CRS\_CR\_AUTOTRIMEN}}) == (\mbox{\hyperlink{group___peripheral___registers___bits___definition_gafa48432b942f1896e05a2eff91178edd}{CRS\_CR\_AUTOTRIMEN}})) ? 1UL : 0UL);}
\DoxyCodeLine{273 \}}
\DoxyCodeLine{274 }
\DoxyCodeLine{283 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_SetHSI48SmoothTrimming(uint32\_t Value)}
\DoxyCodeLine{284 \{}
\DoxyCodeLine{285   MODIFY\_REG(CRS-\/>CR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_ga755d695431db14c1b3b15a48ede61c13}{CRS\_CR\_TRIM}}, Value << CRS\_CR\_TRIM\_Pos);}
\DoxyCodeLine{286 \}}
\DoxyCodeLine{287 }
\DoxyCodeLine{293 \_\_STATIC\_INLINE uint32\_t LL\_CRS\_GetHSI48SmoothTrimming(\textcolor{keywordtype}{void})}
\DoxyCodeLine{294 \{}
\DoxyCodeLine{295   \textcolor{keywordflow}{return} (uint32\_t)(READ\_BIT(CRS-\/>CR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_ga755d695431db14c1b3b15a48ede61c13}{CRS\_CR\_TRIM}}) >> CRS\_CR\_TRIM\_Pos);}
\DoxyCodeLine{296 \}}
\DoxyCodeLine{297 }
\DoxyCodeLine{306 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_SetReloadCounter(uint32\_t Value)}
\DoxyCodeLine{307 \{}
\DoxyCodeLine{308   MODIFY\_REG(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_ga7e54b011ada0eeb4b6ed9cdd24d517f9}{CRS\_CFGR\_RELOAD}}, Value);}
\DoxyCodeLine{309 \}}
\DoxyCodeLine{310 }
\DoxyCodeLine{316 \_\_STATIC\_INLINE uint32\_t LL\_CRS\_GetReloadCounter(\textcolor{keywordtype}{void})}
\DoxyCodeLine{317 \{}
\DoxyCodeLine{318   \textcolor{keywordflow}{return} (uint32\_t)(READ\_BIT(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_ga7e54b011ada0eeb4b6ed9cdd24d517f9}{CRS\_CFGR\_RELOAD}}));}
\DoxyCodeLine{319 \}}
\DoxyCodeLine{320 }
\DoxyCodeLine{328 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_SetFreqErrorLimit(uint32\_t Value)}
\DoxyCodeLine{329 \{}
\DoxyCodeLine{330   MODIFY\_REG(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_ga48c70ae21b6a35ed520a2b30df2c4852}{CRS\_CFGR\_FELIM}}, Value << CRS\_CFGR\_FELIM\_Pos);}
\DoxyCodeLine{331 \}}
\DoxyCodeLine{332 }
\DoxyCodeLine{338 \_\_STATIC\_INLINE uint32\_t LL\_CRS\_GetFreqErrorLimit(\textcolor{keywordtype}{void})}
\DoxyCodeLine{339 \{}
\DoxyCodeLine{340   \textcolor{keywordflow}{return} (uint32\_t)(READ\_BIT(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_ga48c70ae21b6a35ed520a2b30df2c4852}{CRS\_CFGR\_FELIM}}) >> CRS\_CFGR\_FELIM\_Pos);}
\DoxyCodeLine{341 \}}
\DoxyCodeLine{342 }
\DoxyCodeLine{357 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_SetSyncDivider(uint32\_t Divider)}
\DoxyCodeLine{358 \{}
\DoxyCodeLine{359   MODIFY\_REG(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gad0b3ee2ab042802997e57d788c640647}{CRS\_CFGR\_SYNCDIV}}, Divider);}
\DoxyCodeLine{360 \}}
\DoxyCodeLine{361 }
\DoxyCodeLine{375 \_\_STATIC\_INLINE uint32\_t LL\_CRS\_GetSyncDivider(\textcolor{keywordtype}{void})}
\DoxyCodeLine{376 \{}
\DoxyCodeLine{377   \textcolor{keywordflow}{return} (uint32\_t)(READ\_BIT(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gad0b3ee2ab042802997e57d788c640647}{CRS\_CFGR\_SYNCDIV}}));}
\DoxyCodeLine{378 \}}
\DoxyCodeLine{379 }
\DoxyCodeLine{389 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_SetSyncSignalSource(uint32\_t Source)}
\DoxyCodeLine{390 \{}
\DoxyCodeLine{391   MODIFY\_REG(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_ga441881d5e657b04236e440918fe63d20}{CRS\_CFGR\_SYNCSRC}}, Source);}
\DoxyCodeLine{392 \}}
\DoxyCodeLine{393 }
\DoxyCodeLine{402 \_\_STATIC\_INLINE uint32\_t LL\_CRS\_GetSyncSignalSource(\textcolor{keywordtype}{void})}
\DoxyCodeLine{403 \{}
\DoxyCodeLine{404   \textcolor{keywordflow}{return} (uint32\_t)(READ\_BIT(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_ga441881d5e657b04236e440918fe63d20}{CRS\_CFGR\_SYNCSRC}}));}
\DoxyCodeLine{405 \}}
\DoxyCodeLine{406 }
\DoxyCodeLine{415 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_SetSyncPolarity(uint32\_t Polarity)}
\DoxyCodeLine{416 \{}
\DoxyCodeLine{417   MODIFY\_REG(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gab28395cefb0927f2118a9a840a2e2d71}{CRS\_CFGR\_SYNCPOL}}, Polarity);}
\DoxyCodeLine{418 \}}
\DoxyCodeLine{419 }
\DoxyCodeLine{427 \_\_STATIC\_INLINE uint32\_t LL\_CRS\_GetSyncPolarity(\textcolor{keywordtype}{void})}
\DoxyCodeLine{428 \{}
\DoxyCodeLine{429   \textcolor{keywordflow}{return} (uint32\_t)(READ\_BIT(CRS-\/>CFGR, \mbox{\hyperlink{group___peripheral___registers___bits___definition_gab28395cefb0927f2118a9a840a2e2d71}{CRS\_CFGR\_SYNCPOL}}));}
\DoxyCodeLine{430 \}}
\DoxyCodeLine{431 }
\DoxyCodeLine{450 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} LL\_CRS\_ConfigSynchronization(uint32\_t HSI48CalibrationValue, uint32\_t ErrorLimitValue, uint32\_t ReloadValue, uint32\_t Settings)}
\DoxyCodeLine{451 \{}
...
\DoxyCodeLine{779 }
\DoxyCodeLine{780 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* STM32H7xx\_LL\_CRS\_H */}\textcolor{preprocessor}{}}
