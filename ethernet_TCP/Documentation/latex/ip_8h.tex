\hypertarget{ip_8h}{}\doxysection{C\+:/\+Users/\+User\+\_\+4/\+STM32\+Cube\+IDE/workspace\+\_\+1.10.1/ethernet\+\_\+\+UDB/\+Middlewares/\+Third\+\_\+\+Party/\+Lw\+IP/src/include/lwip/ip.h File Reference}
\label{ip_8h}\index{C:/Users/User\_4/STM32CubeIDE/workspace\_1.10.1/ethernet\_UDB/Middlewares/Third\_Party/LwIP/src/include/lwip/ip.h@{C:/Users/User\_4/STM32CubeIDE/workspace\_1.10.1/ethernet\_UDB/Middlewares/Third\_Party/LwIP/src/include/lwip/ip.h}}
...
\#define {\bfseries LWIP\+\_\+\+IP\+\_\+\+HDRINCL}~NULL
\item 
\#define \mbox{\hyperlink{ip_8h_a355679dba1c0d8ef07ce3abcd28e3063}{LWIP\+\_\+\+IP\+\_\+\+CHECK\+\_\+\+PBUF\+\_\+\+REF\+\_\+\+COUNT\+\_\+\+FOR\+\_\+\+TX}}(p)~LWIP\+\_\+\+ASSERT(\char`\"{}p-\/$>$ref == 1\char`\"{}, (p)-\/$>$ref == 1)
\item 
\mbox{\Hypertarget{ip_8h_a5c3e02609bc2d7ce940a1c9a5470b5c3}\label{ip_8h_a5c3e02609bc2d7ce940a1c9a5470b5c3}} 
\#define {\bfseries IP\+\_\+\+PCB\+\_\+\+NETIFHINT}
\item 
\#define \mbox{\hyperlink{ip_8h_a8bdf4b5f674375e76cdd968826d80e53}{IP\+\_\+\+PCB}}
\item 
\mbox{\Hypertarget{ip_8h_aa40b3366a7939ec3a60e9a7d239575e2}\label{ip_8h_aa40b3366a7939ec3a60e9a7d239575e2}} 
\#define {\bfseries SOF\+\_\+\+REUSEADDR}~0x04U  /$\ast$ allow local address reuse $\ast$/
\item 
\mbox{\Hypertarget{ip_8h_a1f7f7efb095c77c06af5c5e8ba558d45}\label{ip_8h_a1f7f7efb095c77c06af5c5e8ba558d45}} 
\#define {\bfseries SOF\+\_\+\+KEEPALIVE}~0x08U  /$\ast$ keep connections alive $\ast$/
\item 
\mbox{\Hypertarget{ip_8h_ac8c7ccdad2d7d3a264bd8cfc57140ca8}\label{ip_8h_ac8c7ccdad2d7d3a264bd8cfc57140ca8}} 
\#define {\bfseries SOF\+\_\+\+BROADCAST}~0x20U  /$\ast$ permit to send and to receive broadcast messages (see \mbox{\hyperlink{group__lwip__opts__ipv4_ga0b2c993fd940f5774108298933310384}{IP\+\_\+\+SOF\+\_\+\+BROADCAST}} option) $\ast$/
\item 
\mbox{\Hypertarget{ip_8h_ae4bbdf8a2e757d758ec0e1c91b58893f}\label{ip_8h_ae4bbdf8a2e757d758ec0e1c91b58893f}} 
\#define {\bfseries SOF\+\_\+\+INHERITED}~(SOF\+\_\+\+REUSEADDR$\vert$SOF\+\_\+\+KEEPALIVE)
\item 
...
\item 
\#define \mbox{\hyperlink{ip_8h_a13f48cf825c7f074dc05bea54e9d6a93}{ip\+\_\+set\+\_\+option}}(pcb,  opt)~((pcb)-\/$>$so\+\_\+options = (u8\+\_\+t)((pcb)-\/$>$so\+\_\+options $\vert$ (opt)))
\item 
\#define \mbox{\hyperlink{ip_8h_a441c63f00c4b0cb69fc34ca6b55307cc}{ip\+\_\+reset\+\_\+option}}(pcb,  opt)~((pcb)-\/$>$so\+\_\+options = (u8\+\_\+t)((pcb)-\/$>$so\+\_\+options \& $\sim$(opt)))
\item 
\#define \mbox{\hyperlink{ip_8h_ae392fc1ebc42a4b08f73d42c04089be9}{ip\+\_\+route\+\_\+get\+\_\+local\+\_\+ip}}(src,  dest,  \mbox{\hyperlink{structnetif}{netif}},  ipaddr)
\end{DoxyCompactItemize}
...
Union destination address of current\+\_\+header \mbox{\Hypertarget{ip_8h_a9135977868017c3deeec86b525e13997}\label{ip_8h_a9135977868017c3deeec86b525e13997}} 
\index{ip.h@{ip.h}!ip\_current\_dest\_addr@{ip\_current\_dest\_addr}}
\index{ip\_current\_dest\_addr@{ip\_current\_dest\_addr}!ip.h@{ip.h}}
...
Union destination address of current\+\_\+header \mbox{\Hypertarget{ip_8h_a2ca15ea285a10982294378cd7b8e83e2}\label{ip_8h_a2ca15ea285a10982294378cd7b8e83e2}} 
...
Total header length of ip(6)\+\_\+current\+\_\+header() (i.\+e. after this, the UDP/\+TCP header starts) \mbox{\Hypertarget{ip_8h_ae214afa9d3f1b26fc8d538436b8fa3c4}\label{ip_8h_ae214afa9d3f1b26fc8d538436b8fa3c4}} 
...
Get the interface that received the current packet. This function must only be called from a receive callback (udp\+\_\+recv, raw\+\_\+recv, tcp\+\_\+accept). It will return NULL otherwise. \mbox{\Hypertarget{ip_8h_aabecef3c7653a9767c79245c44fcab9f}\label{ip_8h_aabecef3c7653a9767c79245c44fcab9f}} 
...
Union source address of current\+\_\+header \mbox{\Hypertarget{ip_8h_a4e35b7692c228c98e738892f0a215647}\label{ip_8h_a4e35b7692c228c98e738892f0a215647}} 
\index{ip.h@{ip.h}!ip\_current\_src\_addr@{ip\_current\_src\_addr}}
\index{ip\_current\_src\_addr@{ip\_current\_src\_addr}!ip.h@{ip.h}}
...
Union source address of current\+\_\+header \mbox{\Hypertarget{ip_8h_a26e077f52de4a97ff89c02415c084518}\label{ip_8h_a26e077f52de4a97ff89c02415c084518}} 
...
Gets an IP pcb option (SOF\+\_\+$\ast$ flags) \mbox{\Hypertarget{ip_8h_a8bdf4b5f674375e76cdd968826d80e53}\label{ip_8h_a8bdf4b5f674375e76cdd968826d80e53}} 
\index{ip.h@{ip.h}!IP\_PCB@{IP\_PCB}}
\index{IP\_PCB@{IP\_PCB}!ip.h@{ip.h}}
\doxysubsubsection{\texorpdfstring{IP\_PCB}{IP\_PCB}}
{\footnotesize\ttfamily \#define IP\+\_\+\+PCB}
...
\DoxyCodeLine{  \textcolor{comment}{/* Bound netif index */}                  \(\backslash\)}
\DoxyCodeLine{  u8\_t netif\_idx;                          \(\backslash\)}
...
{\footnotesize\ttfamily \#define ip\+\_\+reset\+\_\+option(\begin{DoxyParamCaption}\item[{}]{pcb,  }\item[{}]{opt }\end{DoxyParamCaption})~((pcb)-\/$>$so\+\_\+options = (u8\+\_\+t)((pcb)-\/$>$so\+\_\+options \& $\sim$(opt)))}

Resets an IP pcb option (SOF\+\_\+$\ast$ flags) \mbox{\Hypertarget{ip_8h_ae392fc1ebc42a4b08f73d42c04089be9}\label{ip_8h_ae392fc1ebc42a4b08f73d42c04089be9}} 
...
{\footnotesize\ttfamily \#define ip\+\_\+set\+\_\+option(\begin{DoxyParamCaption}\item[{}]{pcb,  }\item[{}]{opt }\end{DoxyParamCaption})~((pcb)-\/$>$so\+\_\+options = (u8\+\_\+t)((pcb)-\/$>$so\+\_\+options $\vert$ (opt)))}

Sets an IP pcb option (SOF\+\_\+$\ast$ flags) \mbox{\Hypertarget{ip_8h_a355679dba1c0d8ef07ce3abcd28e3063}\label{ip_8h_a355679dba1c0d8ef07ce3abcd28e3063}} 
...
{\footnotesize\ttfamily \#define LWIP\+\_\+\+IP\+\_\+\+CHECK\+\_\+\+PBUF\+\_\+\+REF\+\_\+\+COUNT\+\_\+\+FOR\+\_\+\+TX(\begin{DoxyParamCaption}\item[{}]{p }\end{DoxyParamCaption})~LWIP\+\_\+\+ASSERT(\char`\"{}p-\/$>$ref == 1\char`\"{}, (p)-\/$>$ref == 1)}
